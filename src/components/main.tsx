...
const Main = () => {
  return (
    <main className="bg-white flex justify-center items-center px-4 sm:px-6 lg:px-8 pt-20 md:pt-0 mb-25 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20 flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
        <div className="md:w-1/2 text-center md:text-left space-y-4">
          ...
          <a
            href="/talk"
            className="mt-6 bg-red-700 text-white text-base sm:text-lg font-semibold py-3 px-6 rounded-full shadow-md hover:bg-red-800 transition duration-300 transform hover:scale-105"
          >
            Get your diagnosis
          </a>
        </div>
