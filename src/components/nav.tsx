         ...
         <label className="cursor-pointer md:hidden block">
               ...
               <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                  <nav>
                     <ul className="md:flex items-center justify-between text-base text-black-600 pt-4 md:pt-0">
                        ...
                        <li><a className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2" href="#">Forum</a></li>
               ...
               <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
                  <div className="auth flex items-center w-full md:w-full">
                     ...
                     <button className="bg-red-600 text-gray-200  p-2 rounded  hover:bg-red-700 hover:text-gray-100">Sign up</button>
                  </div>
               </div>
            </div>
         </nav>
